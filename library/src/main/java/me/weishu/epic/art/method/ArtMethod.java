...
//        if (constructor != null) {
//            address = HookUtil.getMethodAddress(constructor);
//        } else {
//            address = HookUtil.getMethodAddress(method);
//        }
    }
...
//        final long rule2Address = HookUtil.getMethodAddress(rule2);
//        final long rule1Address = HookUtil.getMethodAddress(rule1);
